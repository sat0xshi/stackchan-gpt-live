...
void Application::InitializeProtocol() {
    ...
    // StackChan GPT-Live variant: preserve the application, display, motion,
    // and audio services, replacing only the upstream agent transport.
    protocol_ = std::make_unique<GptLiveProtocol>();
